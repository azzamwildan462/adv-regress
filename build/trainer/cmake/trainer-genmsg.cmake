...
message(STATUS "trainer: 1 messages, 0 services")

set(MSG_I_FLAGS "-Itrainer:/home/wildan/proyek/qt/ros_qt/p1/src/trainer/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/wildan/proyek/qt/ros_qt/p1/src/trainer/msg/LUT.msg" NAME_WE)
add_custom_target(_trainer_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "trainer" "/home/wildan/proyek/qt/ros_qt/p1/src/trainer/msg/LUT.msg" ""
)
...
_generate_msg_cpp(trainer
  "/home/wildan/proyek/qt/ros_qt/p1/src/trainer/msg/LUT.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/trainer)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/trainer\")")
  # install generated code
  install(
